<%-- 
    Document   : newsInsert
    Created on : Oct 13, 2011, 12:00:32 AM
...
<f:view>
    <html>
            ...
            <div class="block-border"><div class="block-content">
                    ...
                    <h:form>
                        <rich:panel style="width:100%; align:center;" id="main">
                            <a4j:outputPanel id="tableNewsType" ajaxRendered="true">
                                <rich:dataTable rows="20" id="listNewsType" onRowMouseOver="this.style.backgroundColor='#F1F1F1'"
                                                onRowMouseOut="this.style.backgroundColor='#{a4jSkin.tableBackgroundColor}'"
                                                cellpadding="0" cellspacing="0" rowKeyVar="row" width="100%"
                                                style="height:auto; font-size:12px;" border="0" var="rowNews" value="#{NewsTypeBC.listNewsType}">
                                    ...
                                    <rich:column style="width:auto;" >
                                        ...
                                        <h:outputLabel value="#{rowNews.typeName}" />
                                    </rich:column>
                                ...
                                <a4j:commandButton id="insertButton"
                                                   ...
                                                   value="  Insert new News Type  " styleClass="khungInsert">
                                </a4j:commandButton>
                            </a4j:outputPanel>
                        </rich:panel>
                    </h:form>
        ...
        <rich:modalPanel id="updatePanel" autosized="true" width="200">
            <f:facet name="header">
                <h:outputLabel value="Update News Type Panel" />
            </f:facet>
            ...
            <h:form>
                <a4j:outputPanel ajaxRendered="true">
                    <h:panelGrid columns="1">
                            ...
                            <h:inputText value="#{NewsTypeBC.newsType.typeName}" maxlength="100" size="72"
                                         id="fbi2">
                                <rich:ajaxValidator event="onblur"/>
                            </h:inputText>
                            <rich:message for="fbi2" style="color:red;"/>

                            <a4j:commandButton value="Update" action="#{NewsTypeBC.updateNewsType}" reRender="main"
                                               oncomplete="if(#{NewsTypeBC.errors==0})#{rich:component('updatePanel')}.hide();"
        ...
        <rich:modalPanel id="deletePanel" autosized="true" width="400">
            <f:facet name="header">
                <h:outputLabel value="Delete News Type Panel" />
            </f:facet>
            <f:facet name="controls">
                <h:panelGroup>
            ...
            <h:form>
                <a4j:outputPanel ajaxRendered="true">
                    <center>
                        <h:outputLabel value="Are you sure to delete this News Type ?"/>
                        <h:panelGrid columns="2" style="text-align:center">
                            <a4j:commandButton size="50" value="Yes" action="#{NewsTypeBC.deleteNewsType}" reRender="main" oncomplete="#{rich:component('deletePanel')}.hide();" />
        ...
        <rich:modalPanel id="insertPanel" autosized="true" width="200">
            <f:facet name="header">
                <h:outputLabel value="Insert News Type Panel"/>
            </f:facet>
            <f:facet name="controls">
                <h:panelGroup>
                ...
                <a4j:outputPanel ajaxRendered="true">
                    <h:panelGrid columns="1">
                        <h:panelGrid columns="1">
                            ...
                            <rich:message for="fbi" style="color:red;"/>
                            <a4j:commandButton value=" Insert " action="#{NewsTypeBC.createNewsType}" reRender="main"
                                               oncomplete="if(#{NewsTypeBC.errors==0})#{rich:component('insertPanel')}.hide();" styleClass="khungSave2"/>
                        </h:panelGrid>
                    </h:panelGrid>
                </a4j:outputPanel>
            </h:form>
