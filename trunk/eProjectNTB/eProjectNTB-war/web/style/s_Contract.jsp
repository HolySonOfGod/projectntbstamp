...
<f:subview id="header">
    ...
    <nav id="main-nav">
        ...
        <ul class="container_12">
           ...
           <li class="stats"><a href="buildingpage.jsp" title="Selling">Selling</a>
            ...
            <li class="write current"><a href="Contract.jsp" title="Contracts">Contracts</a>
                <ul><li class="current"><a href="#" title="Menu">Menu</a></li></ul>
            </li>
    ...
    <div id="status-bar"><div class="container_12">
            ...
            <ul id="breadcrumb">
                <li><a href="Contract.jsp" title="Contract">Contract</a></li>
                <li><a href="paymentmode.jsp" title="Payment Mode">Payment Mode</a></li>
                <li><a href="PaymentDetail.jsp" title="Payment Detail">Payment Detail</a></li>
            </ul>
