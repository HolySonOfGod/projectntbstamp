...
<f:subview id="header">
    ...
    <nav id="main-nav">
        ...
        <ul class="container_12">           
            <li class="stats current"><a href="buildingpage.jsp" title="Selling">Selling</a>
    ...
    <div id="status-bar"><div class="container_12">
            ...
            <ul id="breadcrumb">
                <li><a href="countrypage.jsp" title="Country">Country</a></li>
                <li><a href="locationpage.jsp" title="Location">Location</a></li>
                <li><a href="landpage.jsp" title="Land">Land</a></li>
                <li><a href="permitpage.jsp" title="Permit">Permit</a></li>                
                <li><a href="buildingpage.jsp" title="Building">Building</a></li>
                <li><a href="floor.jsp" title="Floor">Floor</a></li>
                <li><a href="ApartmentType.jsp" title="Apartment Type">Apartment Type</a></li>
                <li><a href="Apartment.jsp" title="Apartment">Apartment</a></li>
                <li><a href="image.jsp" title="Images Upload">Images Upload</a></li>
                <li><a href="articlepage.jsp" title="Article">Article</a></li>
            </ul>
